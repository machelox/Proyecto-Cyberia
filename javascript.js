<script>
  ...
  $(document).ready(function () {
    ...
    // NOTA: El handler de #btnHistorialVentas ha sido movido a js-ventas.html
      ...
      if (!panel.hasClass('loaded')) {
        switch (targetPanelId) {
          case 'panelInventario':
            if (typeof window.inicializarPanelInventario === 'function') {
              window.inicializarPanelInventario();
            }
            break;
          case 'panelVentas':
            if (typeof window.inicializarPanelVentas === 'function') {
              window.inicializarPanelVentas();
            }
            break;
          case 'panelPagos':
              initPagosYape();
    ...
    //----------------------------------------------------
    // NOTA: El código del módulo de inventario ha sido movido a js-inventario.html
    // Las funciones están disponibles a través de window.cargarModuloInventario
    // y window.inicializarPanelInventario
    //----------------------------------------------------
    // 6. MÓDULO DE VENTAS Y PAGOS
    //----------------------------------------------------
    // NOTA: El código del módulo de ventas ha sido movido a js-ventas.html
    // Las funciones están disponibles a través de window.cargarProductosParaVenta
    // y window.inicializarPanelVentas
...
//----------------------------------------------------
    ...
    // NOTA: Los handlers de historial y verificación de turno han sido movidos a js-ventas.html
    //----------------------------------------------------
